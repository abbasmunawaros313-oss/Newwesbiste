  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100 p-4">
      ...
      >
        ...
        {/* --- 2. Image Panel (Left Side) --- */}
        <div className="hidden lg:block lg:w-1/2 relative">
          <img
            src="https://images.unsplash.com/photo-1507525428034-b723cf961d3e?q=80&w=2073&auto=format&fit=crop" // Beautiful beach image
            alt="Tropical beach"
          ...
          <div className="relative z-10 flex flex-col justify-end h-full p-12 bg-black/40">
            ...
            >
              Get access to exclusive deals, visa tracking, and your complete
