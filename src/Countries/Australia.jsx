...
import {
  ...
  FaDollarSign // Icon for AUD
} from 'react-icons/fa';

// --- Page Data ---
// Data fetched directly from ostravels.com/schengen-visa-file-processing/australia-visa/

const processingService = {
  title: "Australia Visitor Visa (Subclass 600)",
  subtitle: "Complete File Processing Service",
  totalFee: "195 AUD + Service Charges", // From your site
  processingTime: "Approx. 28 Days (After Biometrics)", // From your site
  validity: "Up to 1 Year (Multiple Entry)",
  stay: "Up to 3 Months (per entry)",
  category: "Visitor Visa (Subclass 600)",
  // This is the core service you offer
  serviceIncludes: [
    "Complete Visa File Preparation",
    "Online Application (ImmiAccount) Filing",
    "Visa Appointment Scheduling at VFS Global (for Biometrics)",
    "Travel Insurance (Australia Approved)",
  ...
  note: "Govt. fee (195 AUD) and VFS Global fee are paid separately from our expert service charges. All fees are non-refundable."
};

const highCommissionInfo = {
  title: "Australian High Commission, Islamabad",
  address: "Diplomatic Enclave No. 1, Sector G-5/4, Islamabad",
  phone: "(051) 835 5500",
  email: "N/A (Contact via web form)",
  note: "All visa applications are filed online and biometrics are submitted at VFS Global."
};

const vfsInfo = {
  title: "Australia Visa Application Centre (VFS Global)",
  address: "Park Road, Chak Shahzad, (Opposite CDA Park), Islamabad",
  phone: "0900 07860 (VFS Helpline)",
  email: "info.aupk@vfshelpline.com",
...
const faqs = [
  {
    q: "How do I apply for an Australia visa?",
    a: "The application is filed 100% online through the official 'ImmiAccount' portal. After submission, you must book an appointment at VFS Global for biometrics. O.S. Travel & Tours manages this entire complex process for you."
  },
  {
    q: "What is the 'Subclass 600' visa?",
    a: "This is the standard visitor visa for tourism or visiting family and friends in Australia. Our file processing service is for this category."
  },
  {
    q: "How much bank balance is required for an Australia visa?",
    a: "It is crucial to show strong financial ties. We recommend a consistent bank statement with a strong closing balance, ideally over PKR 2,000,000, along with proof of steady income (salary/business)."
  }
];

// --- Australia-Specific Reviews ---
const reviews = [
  {
    name: "Waqas A.",
    quote: "The Australia visa process is very long and difficult, but O.S. Travel & Tours are true professionals. They built a very strong file for me and I got my visa. Thank you!",
    rating: 5
  },
  {
    name: "S. Malik",
    quote: "I highly recommend their file processing service. They handled my online ImmiAccount application and VFS biometrics appointment. Very smooth.",
    rating: 5
  },
  {
    name: "The Gill Family",
    quote: "We used O.S. Travel for our family visitor visa to Sydney. They processed all our applications. The file was perfect, and the visa was approved. Thank you!",
    rating: 5
  }
];
  ...
  return (
    ...
    >
      ...
      <motion.div variants={itemVariants} className="flex items-center gap-4 mb-8">
        <img
          src="https://flagcdn.com/w160/au.png" // Australia flag
      ...
      >
        <h2 className="text-3xl font-bold text-gray-800 mb-6 text-center">
          Why Choose O.S. Travel for Your <span className="text-blue-600">Australia Visa</span>?
        </h2>
        <p className="text-lg text-gray-600 text-center mb-8 max-w-3xl mx-auto">
          As the "best and top travel consultant" in Islamabad, we have an "amazing success ratio" for Australian visas.
          <strong className="text-gray-800"> We deal in complete visa file processing and appointment scheduling</strong> to ensure your application is successful.
        </p>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <ServiceCard
            icon={<FaFileSignature className="text-blue-500" />}
            title="ImmiAccount File Processing"
            desc="Expert preparation of your entire application on the official Australian portal."
          />
          <ServiceCard
      ...
      <motion.div variants={itemVariants} className="text-center mt-10 text-sm text-gray-500">
        <p>Visa approval is at the sole discretion of the Australian Department of Home Affairs. O.S. Travel & Tours provides expert file preparation services.</p>
      </motion.div>
...
const FileProcessingCard = ({ visa }) => {
  return (
    <div className={`bg-white rounded-lg shadow-xl overflow-hidden border-t-8 border-blue-600`}> {/* Australia Blue */}
      <div className="p-6 md:p-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-y-6 gap-x-4 mb-6 pt-4 border-t border-gray-100">
          <DetailItem icon={<FaDollarSign className="text-green-600" />} label="Govt. Visa Fee" value={visa.totalFee} />
