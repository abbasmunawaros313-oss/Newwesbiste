...
// --- Page Data ---
// Data modeled on your France page for Schengen File Processing.
...
const processingService = {
  ...
  note: "This fee includes Embassy Fee, VFS Fee, and our expert service charges. Fees are non-refundable."
};

const embassyInfo = {
  title: "Embassy of Austria, Islamabad",
  address: "House 7, Street 17, Sector F-7/2, Islamabad, Pakistan",
  phone: "(051) 2654951",
...
const vfsInfo = {
  title: "Austria Visa Application Centre (VFS Global)",
  address: "Park Road, Chak Shahzad, (Opposite CDA Park), Islamabad",
  phone: "0900 07860 (from mobile)",
  email: "info.auspk@vfshelpline.com",
  note: "This is the official partner for submitting your application and biometrics."
};

// --- Austria-Specific FAQs ---
const faqs = [
  {
    q: "What does 'Schengen Visa File Processing' mean?",
    a: "It means O.S. Travel & Tours handles the entire complex process for you. We fill the forms, book your flight/hotel reservations, arrange your travel insurance, and schedule your appointment at VFS. You just provide your personal documents."
  },
  {
    q: "Can I go directly to the Austrian Embassy?",
    a: "No. The Embassy of Austria has outsourced all visa submissions to their official partner, VFS Global. We will book your appointment at the VFS Global centre for you to submit your file and give biometrics."
  },
  {
    q: "How much bank balance is required for an Austria Schengen visa?",
    a: "It is highly recommended to show a strong, consistent bank statement with a closing balance of at least PKR 1,000,000 to PKR 1,500,000 to prove you can afford your trip."
  }
];

// --- Austria/Schengen-Specific Reviews ---
const reviews = [
  {
    name: "Zainab A.",
    quote: "O.S. Travel is the best for Schengen visas. They prepared my entire file for my Austria trip. I was so worried, but they handled everything. Got my visa in 15 days!",
    rating: 5
  },
  {
    name: "Usman Khan",
  ...
  {
    name: "The Ali Family",
    quote: "We used O.S. Travel for our family vacation to Vienna. They processed all 5 of our applications. The file was perfect, and the visa was approved. Thank you!",
    rating: 5
  }
];
  ...
  return (
    ...
    >
      ...
      <motion.div variants={itemVariants} className="flex items-center gap-4 mb-8">
        <img
          src="https://flagcdn.com/w160/at.png" // Austria flag
          alt="Flag of Austria"
      ...
      >
        <h2 className="text-3xl font-bold text-gray-800 mb-6 text-center">
          Why Choose O.S. Travel for Your <span className="text-blue-600">Schengen Visa</span>?
        </h2>
        <p className="text-lg text-gray-600 text-center mb-8 max-w-3xl mx-auto">
          The Schengen visa is the most complex application. We are expert visa consultants in Islamabad.
      ...
      <motion.div variants={itemVariants} className="text-center mt-10 text-sm text-gray-500">
        <p>Visa approval is at the sole discretion of the Embassy of Austria. O.S. Travel & Tours provides expert file preparation services.</p>
      </motion.div>
    ...
    <div className={`bg-white rounded-lg shadow-xl overflow-hidden border-t-8 border-blue-600`}>
      <div className="p-6 md:p-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-y-6 gap-x-4 mb-6 pt-4 border-t border-gray-100">
          <DetailItem icon={<FaMoneyBillWave className="text-green-600" />} label="Total Package Fee" value={visa.totalFee} />
