...
import {
  ...
  FaChevronDown, FaStar, FaQuoteLeft, FaPlane, FaHotel, FaUmbrellaBeach, FaLaptopCode
} from 'react-icons/fa';
...
const embassyInfo = {
  ...
  phone: "+92 51-260-07-04 / +92 51-260-07-03",
  fax: "+92 51-260-07-20",
...
const reviews = [
  {
    name: "Kamran A.",
    quote: "Got my Azerbaijan ASAN e-visa in just 3 days through O.S. Travel. Incredibly fast and smooth process. Highly recommend them for a Baku trip!",
    rating: 5
  },
  {
    name: "Sadia M.",
  ...
  return (
    ...
    >
      ...
      <motion.div variants={itemVariants} className="flex items-center gap-4 mb-8">
        <img
          src="https://flagcdn.com/w160/az.png" // Azerbaijan flag
