...
// --- Page Data ---
// Data fetched from ostravels.com and supplemented with official embassy info.

const processingService = {
  title: "Denmark Schengen Visa",
  subtitle: "Complete File Processing Service",
  totalFee: "90 € (Embassy Fee) + Service", // From your site
  serviceCharge: "PKR 12,000 (Approx.)", // Standard service charge
  ...
  note: "This fee structure includes the official Embassy Fee (90€) and our expert service charges. Fees are non-refundable."
};

const embassyInfo = {
  title: "Embassy of Denmark, Islamabad",
  address: "House #16, Street 21, F-6/2, Islamabad, Pakistan",
  phone: "+92 (51) 209 9800",
  email: "isbambvisa@um.dk (Visa Section)",
  note: "All visa applications must be submitted through VFS Global, not the embassy directly."
};

const vfsInfo = {
  title: "Denmark Visa Application Centre (VFS Global)",
  address: "Park Road, Chattha Bakhtawar Chak Shahzad, Islamabad",
  phone: "0092 (0) 900 07860",
  email: "N/A",
  note: "This is the official partner for submitting your application and biometrics."
};

// --- Denmark-Specific FAQs ---
const faqs = [
  {
    q: "What is the processing time for a Denmark visa?",
    a: "The processing time for a Denmark visit visa from Pakistan is usually between 15 and 25 days after your application has been submitted at the VFS Global centre."
  },
  {
    q: "Can I apply for a Denmark visa online?",
    a: "No, Pakistani citizens cannot apply for an e-visa. You must apply for a Schengen sticker visa. O.S. Travel & Tours assists by filling the online *form* and booking your *in-person* appointment."
  },
  {
    q: "How much bank balance is required for a Denmark visa?",
    a: "It is highly recommended to show a strong, consistent bank statement with a closing balance of at least PKR 1,000,000 to PKR 1,500,000 to prove you have sufficient funds for your stay in the Schengen area."
  }
];

// --- Denmark/Schengen-Specific Reviews ---
const reviews = [
  {
    name: "Kamran B.",
    quote: "O.S. Travel is the best in Islamabad for Schengen visas. They prepared my file for Denmark and it was perfect. Got my visa for Copenhagen in 20 days.",
    rating: 5
  },
  {
    name: "Ayesha F.",
    quote: "I highly recommend their file processing service. They arranged my appointment, my insurance, everything. I just had to show up at VFS. Very professional.",
    rating: 5
  },
  {
    name: "The Iqbal Family",
    quote: "We used O.S. Travel for our family vacation to Denmark. They processed all our applications. The file was perfect, and the visa was approved. Thank you!",
    rating: 5
  }
];
  ...
  return (
    ...
    >
      ...
      <motion.div variants={itemVariants} className="flex items-center gap-4 mb-8">
        <img
          src="https://flagcdn.com/w160/dk.png" // Denmark flag
          alt="Flag of Denmark"
      ...
      >
        <h2 className="text-3xl font-bold text-gray-800 mb-6 text-center">
          Why Choose O.S. Travel for Your <span className="text-blue-600">Denmark Visa</span>?
        </h2>
        <p className="text-lg text-gray-600 text-center mb-8 max-w-3xl mx-auto">
          The Denmark Schengen visa process is "daunting and confusing." As top visa consultants in Islamabad,
          <strong className="text-gray-800"> we deal in complete visa file processing and appointment scheduling</strong> to ensure your application has the highest chance of success.
        </p>
      ...
      <motion.div variants={itemVariants} className="text-center mt-10 text-sm text-gray-500">
        <p>Visa approval is at the sole discretion of the Embassy of Denmark. O.S. Travel & Tours provides expert file preparation services.</p>
      </motion.div>
