...
// --- Page Data ---
// Data based on official Schengen requirements, modeled on your other Schengen pages.

const processingService = {
  title: "Finland Schengen Visa",
  subtitle: "Complete File Processing Service",
  embassyFee: "90 EUR (Visa Fee) + Service Charges", // As requested
  serviceCharge: "PKR 12,000", // As requested
  ...
  documents: [
    ...
    "04 Pictures with White Background (Schengen specs)",
    "Last 6-month Bank Statement & Maintenance Letter",
    "CNIC Photo Copy (front & back)",
    "Family Registration Certificate (FRC) or MRC",
    "NTN & 3 Years' Tax Returns",
    "Employment Letter / Business Documents"
  ],
  note: "Embassy fee (90 EUR) and VFS Global fee are paid separately from our service charges. All fees are non-refundable."
};

const embassyInfo = {
  title: "Embassy of Finland, Islamabad",
  address: "House No. 11, Street 88, G-6/3, Islamabad, Pakistan",
  phone: "+92 51 227 6100",
  email: "sanomat.ISL@gov.fi",
  note: "All visa applications are submitted through VFS Global, not the embassy directly."
};

const vfsInfo = {
  title: "Finland Visa Application Centre (VFS Global)",
  address: "Park Road, Chak Shahzad, (Opposite CDA Park), Islamabad",
  phone: "0900 07860 (VFS Helpline)",
  email: "info.finlandpk@vfshelpline.com",
  note: "This is the official partner for submitting your application and biometrics."
};

// --- Finland-Specific FAQs ---
const faqs = [
  {
    q: "Is Finland a Schengen country?",
    a: "Yes, Finland is a full member of the Schengen Area. A visa for Finland is a Schengen visa, allowing you to travel to all 29 member countries."
  },
  {
    q: "Can I apply for a Finland visa online?",
    a: "No, Pakistani citizens must apply for a sticker visa. This requires an online application *form*, followed by an *in-person* appointment at VFS Global for file submission and biometrics. O.S. Travel & Tours manages this entire process for you."
  },
  {
    q: "How much is the visa fee in Pakistani Rupees?",
    a: "The embassy fee is fixed at 90 EUR. The amount in PKR will vary based on the daily exchange rate at the time of your appointment. Our service charges and the VFS service fee are paid separately."
  }
];

// --- Finland/Schengen-Specific Reviews ---
const reviews = [
  {
    name: "Omer N.",
    quote: "I wanted to see the Northern Lights. O.S. Travel handled my Finland Schengen visa. They were honest about the requirements and built a very strong file. Got my visa!",
    rating: 5
  },
  {
    name: "S. Khurram",
    quote: "Top-class service. They are the best in Islamabad for Schengen file processing. They handled my appointment, insurance, and all bookings. 10/10.",
    rating: 5
  },
  {
    name: "The Awan Family",
    quote: "We used O.S. Travel for our family vacation to Helsinki. They processed all our applications. The file was perfect, and the visa was approved. Thank you!",
    rating: 5
  }
];
  ...
  return (
    ...
    >
      ...
      <motion.div variants={itemVariants} className="flex items-center gap-4 mb-8">
        <img
          src="https://flagcdn.com/w160/fi.png" // Finland flag
          alt="Flag of Finland"
      ...
      >
        <h2 className="text-3xl font-bold text-gray-800 mb-6 text-center">
          Why Choose O.S. Travel for Your <span className="text-blue-600">Finland Visa</span>?
        </h2>
        <p className="text-lg text-gray-600 text-center mb-8 max-w-3xl mx-auto">
          As expert visa consultants in Islamabad, we specialize in Schengen visa applications.
          <strong className="text-gray-800"> We deal in complete visa file processing and appointment scheduling</strong> to ensure your application is accurate, complete, and has the best chance of success.
        </p>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <ServiceCard
            icon={<FaFileSignature className="text-blue-500" />}
            title="Schengen File Processing"
            desc="Expert preparation of your entire application file, from forms to supporting letters."
          />
          <ServiceCard
      ...
      <motion.div variants={itemVariants} className="text-center mt-10 text-sm text-gray-500">
        <p>Visa approval is at the sole discretion of the Embassy of Finland. O.S. Travel & Tours provides expert file preparation services.</p>
      </motion.div>
  ...
  return (
    <div className={`bg-white rounded-lg shadow-xl overflow-hidden border-t-8 border-blue-600`}>
      <div className="p-6 md:p-8">
        ...
        {/* Details Grid - UPDATED FOR EUR + SERVICE CHARGE */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-y-6 gap-x-4 mb-6 pt-4 border-t border-gray-100">
          <DetailItem icon={<FaEuroSign className="text-green-600" />} label="Embassy Visa Fee" value={visa.embassyFee} />
