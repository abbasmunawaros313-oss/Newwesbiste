...
// --- Page Data ---
// Data fetched directly from ostravels.com/schengen-visa-file-processing/france-visa/
...
const processingService = {
  ...
  note: "Embassy fee (90 EUR) and VFS Global fee are paid separately from our expert service charges. All fees are non-refundable." // Clarified note
};

const embassyInfo = {
  title: "Embassy of France, Islamabad",
  address: "Diplomatic Enclave, G-5, Islamabad, Pakistan",
  phone: "(051) 201 1414",
  email: "contact@ambafrance-pk.org",
  note: "All visa applications are submitted through VFS Global, not the embassy directly."
};

const vfsInfo = {
  title: "France Visa Application Centre (VFS Global)",
  address: "Park Road, Chak Shahzad, (Opposite CDA Park), Islamabad",
  phone: "0900 07860 (VFS Helpline)",
  email: "info.francepk@vfshelpline.com",
  note: "This is the official partner for submitting your application and biometrics."
};

// --- France-Specific FAQs ---
const faqs = [
  {
    q: "What is the processing time for a France visa?",
    a: "Visa applications are generally processed within 25 days. However, in particular cases, this period can be extended up to 45 days, so it is important to apply well in advance."
  },
  {
    q: "Can I apply for a France visa online?",
...
// --- France/Schengen-Specific Reviews ---
const reviews = [
  {
    name: "Omer S.",
    quote: "O.S. Travel is the best for Schengen visas. They prepared my entire file for my France trip. I was so worried, but they handled everything. Got my visa in 3 weeks!",
    rating: 5
  },
  {
    name: "Sana A.",
    quote: "I highly recommend their file processing service for my Paris trip. They arranged my appointment and all my bookings. I just had to show up at VFS. Very professional.",
    rating: 5
  },
  {
    name: "The Bhatti Family",
    quote: "We used O.S. Travel for our family vacation to France. They processed all 5 of our applications. The file was perfect, and the visa was approved. Thank you!",
    rating: 5
  }
];
  ...
  return (
    ...
    >
      ...
      <motion.div variants={itemVariants} className="flex items-center gap-4 mb-8">
        <img
          src="https://flagcdn.com/w160/fr.png" // France flag
          alt="Flag of France"
      ...
      >
        <h2 className="text-3xl font-bold text-gray-800 mb-6 text-center">
          Why Choose O.S. Travel for Your <span className="text-blue-600">France Visa</span>?
        </h2>
        <p className="text-lg text-gray-600 text-center mb-8 max-w-3xl mx-auto">
          As the "best and top travel consultant in the city," we specialize in Schengen visas.
      ...
      <motion.div variants={itemVariants} className="text-center mt-10 text-sm text-gray-500">
        <p>Visa approval is at the sole discretion of the Embassy of France. O.S. Travel & Tours provides expert file preparation services.</p>
      </motion.div>
