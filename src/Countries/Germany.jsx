...
const faqs = [
  ...
  {
    q: "Can I apply for a Germany visa online?",
...
// --- Germany/Schengen-Specific Reviews ---
const reviews = [
  {
    name: "Usman K.",
    quote: "O.S. Travel is the best for Schengen visas. They prepared my entire file for my Germany (Berlin) trip. I was so worried, but they handled everything. Got my visa!",
    rating: 5
  },
  {
    name: "Ayesha M.",
    quote: "I highly recommend their file processing service for my Munich trip. They arranged my appointment and all my bookings. I just had to show up at VFS. Very professional.",
    rating: 5
  },
  {
    name: "The Baig Family",
    quote: "We used O.S. Travel for our family vacation to Germany. They processed all 5 of our applications. The file was perfect, and the visa was approved. Thank you!",
    rating: 5
  }
];
  ...
  return (
    ...
    >
      ...
      <motion.div variants={itemVariants} className="flex items-center gap-4 mb-8">
        <img
          src="https://flagcdn.com/w160/de.png" // Germany flag
          alt="Flag of Germany"
      ...
      >
        <h2 className="text-3xl font-bold text-gray-800 mb-6 text-center">
          Why Choose O.S. Travel for Your <span className="text-blue-600">Germany Visa</span>?
        </h2>
      ...
      <motion.div variants={itemVariants} className="text-center mt-10 text-sm text-gray-500">
        <p>Visa approval is at the sole discretion of the Embassy of Germany. O.S. Travel & Tours provides expert file preparation services.</p>
      </motion.div>
