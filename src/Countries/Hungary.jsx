...
// --- Page Data ---
// Data fetched directly from ostravels.com/schengen-visa-file-processing/hungary-visa/
...
const embassyInfo = {
  title: "Embassy of Hungary, Islamabad",
...
const vfsInfo = {
  title: "Hungary Visa Application Centre (VFS Global)",
  address: "Park Road, Chak Shahzad, (Opposite CDA Park), Islamabad",
  phone: "0900 07860 (VFS Helpline)",
  email: "info.hungarypakistan@vfshelpline.com",
  note: "This is the official partner for submitting your application and biometrics."
};

// --- Hungary-Specific FAQs ---
const faqs = [
  {
    q: "What is the processing time for a Hungary visa?",
    a: "The processing time for a Hungary visit visa from Pakistan is usually between 15 and 25 days after your application has been submitted at the VFS Global centre."
  },
  {
    q: "Can I apply for a Hungary visa online?",
  ...
  {
    q: "Is a Police Clearance Certificate required for a Hungary visa?",
    a: "Yes, your website lists a 'Police clearances' certificate as a required document for the Hungary visa application. We will guide you on obtaining this."
  }
];

// --- Hungary/Schengen-Specific Reviews ---
const reviews = [
  {
    name: "Ahmad R.",
    quote: "O.S. Travel is the best for Schengen visas. They prepared my entire file for my Hungary (Budapest) trip. I was so worried, but they handled everything. Got my visa!",
    rating: 5
  },
  {
    name: "Sonia F.",
    quote: "I highly recommend their file processing service for my Budapest trip. They arranged my appointment and all my bookings. I just had to show up at VFS. Very professional.",
    rating: 5
  },
  {
    name: "The Mirza Family",
    quote: "We used O.S. Travel for our family vacation to Hungary. They processed all our applications. The file was perfect, and the visa was approved. Thank you!",
    rating: 5
  }
];
  ...
  return (
    ...
    >
      ...
      <motion.div variants={itemVariants} className="flex items-center gap-4 mb-8">
        <img
          src="https://flagcdn.com/w160/hu.png" // Hungary flag
          alt="Flag of Hungary"
      ...
      >
        <h2 className="text-3xl font-bold text-gray-800 mb-6 text-center">
          Why Choose O.S. Travel for Your <span className="text-blue-600">Hungary Visa</span>?
        </h2>
      ...
      <motion.div variants={itemVariants} className="text-center mt-10 text-sm text-gray-500">
        <p>Visa approval is at the sole discretion of the Embassy of Hungary. O.S. Travel & Tours provides expert file preparation services.</p>
      </motion.div>
