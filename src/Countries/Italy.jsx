...
// --- Page Data ---
// Data based on official Schengen/Italy visa requirements for Pakistan.
...
const processingService = {
  ...
  serviceIncludes: [
    ...
    "Visa Appointment Scheduling (BLS International)", // Italy uses BLS/Intiana
  ...
  documents: [
    ...
    "Income Tax Returns & NTN (last 2-3 years)",
    "Employment Letter / Business Documents",
    "Invitation Letter (Lettera d'Invito) if visiting family/friends"
  ],
  note: "Embassy fee (90 EUR) and BLS Centre fee are paid separately from our expert service charges. Fees are non-refundable."
};

const embassyInfo = {
  title: "Embassy of Italy, Islamabad",
  address: "Plot 196/208, Street 17, Diplomatic Enclave, G-5, Islamabad",
  phone: "+92 51 283 3183",
  email: "segreteria.islamabad@esteri.it",
  note: "Applications are submitted via the Italy Visa Application Centre (BLS/Intiana)."
};

const vacInfo = {
  title: "Italy Visa Application Centre (BLS/Intiana)",
  address: "G-7 Square Plaza, G-7 Markaz, Islamabad", // BLS Address
  phone: "+92 51 8490870",
  email: "info@theitalyvisa.com",
  note: "We will book your appointment here for file submission and biometrics."
};

// --- Italy-Specific FAQs ---
const faqs = [
  {
    q: "Who processes Italy visa applications in Pakistan?",
    a: "Italy visa applications are processed by the 'Italy Visa Application Centre' (managed by BLS International/Intiana), not VFS Global. We handle the appointment booking for you at the correct center."
  },
  {
    q: "What is the 'Lettera d'Invito'?",
    a: "This is a specific Italian sponsorship form required if you are visiting family or friends in Italy. If you are going for tourism only, we will provide confirmed hotel bookings instead."
  },
  {
    q: "How long does the Italy visa take?",
    a: "The standard processing time is 15 calendar days. However, due to high demand, it can sometimes take up to 45 days. We recommend applying at least 6-8 weeks before your trip."
  }
];

// --- Italy/Schengen-Specific Reviews ---
const reviews = [
  {
    name: "Hamza T.",
    quote: "I needed a visa for a conference in Milan. O.S. Travel handled the appointment booking with BLS and prepared my file perfectly. Got my visa in 3 weeks.",
    rating: 5
  },
  {
    name: "Mrs. Z. Khan",
    quote: "We planned a family trip to Rome and Venice. The team at O.S. Travel is very professional. They managed all our documents and flight reservations.",
    rating: 5
  },
  {
    name: "Ali Raza",
    quote: "Great service for Schengen visas. They know the specific requirements for Italy, which are a bit different from other countries. Highly recommended.",
    rating: 5
  }
];
  ...
  return (
    ...
    >
      ...
      <motion.div variants={itemVariants} className="flex items-center gap-4 mb-8">
        <img
          src="https://flagcdn.com/w160/it.png" // Italy flag
          alt="Flag of Italy"
      ...
      {/* 3. Embassy & VAC Information */}
      <motion.div
        variants={itemVariants}
        className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-8"
      >
        <EmbassyCard info={embassyInfo} />
        <EmbassyCard info={vacInfo} />
      </motion.div>
      ...
      >
        <h2 className="text-3xl font-bold text-gray-800 mb-6 text-center">
          Why Choose O.S. Travel for Your <span className="text-blue-600">Italy Visa</span>?
        </h2>
        <p className="text-lg text-gray-600 text-center mb-8 max-w-3xl mx-auto">
          Securing an appointment and preparing a file for Italy can be challenging. We are expert visa consultants in Islamabad.
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <ServiceCard
            ...
            desc="We assist in securing the difficult-to-get visa appointments at the Italy Visa Centre."
          />
          <ServiceCard
      ...
      <motion.div variants={itemVariants} className="text-center mt-10 text-sm text-gray-500">
        <p>Visa approval is at the sole discretion of the Embassy of Italy. O.S. Travel & Tours provides expert file preparation services.</p>
      </motion.div>
