...
// --- Page Data ---
// Data based on official Schengen/Lithuania requirements via VFS Global.
...
const processingService = {
  ...
  serviceIncludes: [
    ...
    "Application Form Filling (EPM System)",
  ...
  documents: [
    ...
    "Proof of Accommodation (Hotel/Sponsorship)"
  ],
  note: "Embassy fee (90 EUR) and VFS Global fee are paid separately from our expert service charges. Fees are non-refundable."
};

const embassyInfo = {
  title: "Represented by Embassy of Hungary",
  address: "House No. 12, F-6/2, Islamabad, Pakistan",
  phone: "(051) 2276849",
  email: "consulate.isl@mfa.gov.hu",
  note: "Lithuania is often represented by Hungary for short-stay visas in Pakistan, or processed via VFS for the Lithuanian Embassy in Turkey."
};

const vfsInfo = {
  title: "Lithuania Visa Application Centre (VFS)",
  address: "Park Road, Chak Shahzad, (Opposite CDA Park), Islamabad",
  phone: "0900 07860 (VFS Helpline)",
  email: "info.lithuaniapk@vfshelpline.com",
...
const faqs = [
  {
    q: "Is Lithuania a Schengen country?",
    a: "Yes, Lithuania is a full member of the Schengen Area. A visa issued by Lithuania allows you to travel to all 29 Schengen member states."
  },
  {
    q: "Where do I submit my Lithuania visa application?",
    a: "You must submit your application in person at the VFS Global Visa Application Centre. We will schedule this appointment for you as part of our service."
  },
  {
    q: "What is the processing time for a Lithuania visa?",
    a: "The standard processing time is 15 calendar days. However, it can take up to 45 days in some cases, so we recommend applying at least 4-6 weeks before your trip."
  }
];

// --- Lithuania/Schengen-Specific Reviews ---
const reviews = [
  {
    name: "Waqas A.",
    quote: "I needed a visa for a business trip to Vilnius. O.S. Travel knew exactly which embassy represented Lithuania and handled my file perfectly. Got my visa on time.",
    rating: 5
  },
  {
    name: "S. Rashid",
    quote: "Applying for Lithuania can be tricky, but O.S. Travel made it simple. They handled the forms and the appointment booking. Very professional service.",
    rating: 5
  },
  {
    name: "The Jamil Family",
    quote: "We planned a Baltic tour starting in Lithuania. O.S. Travel processed all our family applications. The file was complete and error-free. Highly recommended.",
    rating: 5
  }
];
  ...
  return (
    ...
    >
      ...
      <motion.div variants={itemVariants} className="flex items-center gap-4 mb-8">
        <img
          src="https://flagcdn.com/w160/lt.png" // Lithuania flag
      ...
      >
        <h2 className="text-3xl font-bold text-gray-800 mb-6 text-center">
          Why Choose O.S. Travel for Your <span className="text-blue-600">Lithuania Visa</span>?
        </h2>
        <p className="text-lg text-gray-600 text-center mb-8 max-w-3xl mx-auto">
          Navigating the Schengen visa process for smaller countries like Lithuania can be complex.
          <strong className="text-gray-800"> We deal in complete visa file processing and appointment scheduling</strong> to ensure your application is submitted to the correct authority.
        </p>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <ServiceCard
            icon={<FaFileSignature className="text-blue-500" />}
            title="Schengen File Processing"
            desc="Expert preparation of your entire application file, from online forms to supporting letters."
          />
          <ServiceCard
            icon={<FaCalendarCheck className="text-purple-500" />}
            title="VFS Appointment"
            desc="We secure your visa submission appointment at the correct VFS Global centre."
          />
          <ServiceCard
      ...
      <motion.div variants={itemVariants} className="text-center mt-10 text-sm text-gray-500">
        <p>Visa approval is at the sole discretion of the Embassy. O.S. Travel & Tours provides expert file preparation services.</p>
      </motion.div>
  ...
  return (
    <div className={`bg-white rounded-lg shadow-xl overflow-hidden border-t-8 border-blue-600`}>
      <div className="p-6 md:p-8">
        ...
        {/* Details Grid - UPDATED FOR TOTAL FEE */}
