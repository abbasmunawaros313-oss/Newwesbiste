...
const embassyInfo = {
  title: "Embassy of Nepal in Pakistan",
  address: "House No. 6, Gomal Road, Sector E-7, Islamabad, Pakistan",
  phone: "(+92-51) 2610317, 2610318",
  fax: "(+92-51) 2610320",
  email: "eonislamabad@mofa.gov.np, eonislamabad@gmail.com"
};

// --- Nepal-Specific FAQs ---
const faqs = [
  {
    q: "Can I get a Nepal e-visa?",
    a: "No. As per O.S. Travel & Tours, the Nepal e-visa is not available for Pakistani citizens. You must apply for a sticker visa at the embassy."
  },
  {
    q: "Is a bank statement mandatory for the Nepal visa?",
    a: "Yes, the document checklist provided by O.S. Travel & Tours includes a 'Bank Statement' as a required document."
  },
  {
    q: "How long does the Nepal visa take?",
    a: "The processing time is very fast, listed as only 03 to 05 working days once all documents are submitted."
  }
];

// --- Nepal-Specific Reviews ---
const reviews = [
  {
    name: "Aliya S.",
    quote: "My trip to Kathmandu was a dream. O.S. Travel & Tours handled my visa in just 4 days. I didn't have to worry about anything. Excellent service!",
    rating: 5
  },
  {
    name: "Nadeem B.",
    quote: "I used O.S. Travel for my trekking trip to Nepal. They processed my visa quickly and got me great deals on flights. Very professional.",
    rating: 5
  },
  {
    name: "The Farooq Family",
    quote: "We were confused about the online application form for the Nepal visa, but O.S. Travel took care of everything. Very smooth process.",
    rating: 5
  }
];
  ...
  return (
    ...
    >
      ...
      <motion.div variants={itemVariants} className="flex items-center gap-4 mb-8">
        <img
          src="https://flagcdn.com/w160/np.png" // Nepal flag
          alt="Flag of Nepal"
      ...
      >
        ...
        <p className="text-lg text-gray-600 text-center mb-8 max-w-3xl mx-auto">
          As the "Recommended Visa Agency for Nepal visa," we provide fast and efficient processing.
          <strong className="text-gray-800"> We deal in a wide range of services</strong> to make your Himalayan adventure a reality.
        </p>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <ServiceCard
            icon={<FaPassport className="text-blue-500" />}
            title="Fast Visa Processing"
            desc="We ensure your application is correct and submitted for a 3-5 day processing time."
          />
          <ServiceCard
            icon={<FaPlane className="text-green-500" />}
            title="Air Ticketing"
            desc="Competitive pricing on all flights to Kathmandu and other destinations."
          />
          <ServiceCard
            icon={<FaHotel className="text-purple-500" />}
            title="Hotel Bookings"
            desc="From comfortable hotels in Thamel to mountain lodges, we book it all."
          />
          <ServiceCard
            icon={<FaMountain className="text-yellow-500" />}
            title="Trekking & Tours"
            desc="We can arrange complete trekking packages, city tours, and mountain flights."
          />
        </div>
      </motion.div>
