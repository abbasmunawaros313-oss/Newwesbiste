...
// --- Page Data ---
// Data fetched directly from ostravels.com/schengen-visa-file-processing/netherlands-visa/
...
const embassyInfo = {
  title: "Embassy of the Netherlands, Islamabad",
...
const vfsInfo = {
  title: "Netherlands Visa Application Centre (VFS Global)",
  address: "Park Road, Chak Shahzad, (Opposite CDA Park), Islamabad",
  phone: "0900 07860 (VFS Helpline)",
  email: "info.netherlandspk@vfshelpline.com",
  note: "This is the official partner for submitting your application and biometrics."
};

// --- Netherlands-Specific FAQs ---
const faqs = [
  {
    q: "What is the processing time for a Netherlands visa?",
    a: "The processing time is usually within 15 calendar days, but your site notes it can take up to 45 days in particular cases. We recommend applying at least 6-8 weeks in advance."
  },
  {
    q: "Can I apply for a Netherlands visa online?",
    a: "No, Pakistani citizens must apply for a Schengen sticker visa. This requires an online application *form*, followed by an *in-person* appointment at VFS Global for file submission and biometrics. O.S. Travel & Tours manages this entire process for you."
  },
  {
    q: "How much bank balance is required for a Netherlands visa?",
...
// --- Netherlands/Schengen-Specific Reviews ---
const reviews = [
  {
    name: "Imran A.",
    quote: "O.S. Travel is the best for Schengen visas. They prepared my entire file for my Netherlands (Amsterdam) trip. I was so worried, but they handled everything. Got my visa!",
    rating: 5
  },
  {
    name: "Sana F.",
    quote: "I highly recommend their file processing service for my Amsterdam trip. They arranged my appointment and all my bookings. I just had to show up at VFS. Very professional.",
    rating: 5
  },
  {
    name: "The Malik Family",
    quote: "We used O.S. Travel for our family vacation to the Netherlands. They processed all our applications. The file was perfect, and the visa was approved. Thank you!",
    rating: 5
  }
];
  ...
  return (
    ...
    >
      ...
      <motion.div variants={itemVariants} className="flex items-center gap-4 mb-8">
        <img
          src="https://flagcdn.com/w160/nl.png" // Netherlands flag
      ...
      >
        <h2 className="text-3xl font-bold text-gray-800 mb-6 text-center">
          Why Choose O.S. Travel for Your <span className="text-blue-600">Netherlands Visa</span>?
        </h2>
      ...
      <motion.div variants={itemVariants} className="text-center mt-10 text-sm text-gray-500">
        <p>Visa approval is at the sole discretion of the Embassy of the Netherlands. O.S. Travel & Tours provides expert file preparation services.</p>
      </motion.div>
    ...
    <div className={`bg-white rounded-lg shadow-xl overflow-hidden border-t-8 border-blue-600`}>
      <div className="p-6 md:p-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-y-6 gap-x-4 mb-6 pt-4 border-t border-gray-100">
          ...
          <DetailItem icon={<FaCalendarAlt className="text-blue-6GOO" />} label="Category" value={visa.category} />
        </div>
