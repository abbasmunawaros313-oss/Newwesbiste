...
// --- Page Data ---
// Data fetched directly from ostravels.com/schengen-visa-file-processing/norway-visa/
...
const embassyInfo = {
  title: "Royal Norwegian Embassy, Islamabad",
  address: "House 14, Street 17, Sector F-7/2, Islamabad, Pakistan",
  phone: "(+92) 51 849 7000",
  email: "emb.islamabad@mfa.no",
  note: "All visa applications are submitted through VFS Global, not the embassy directly."
};

const vfsInfo = {
  title: "Norway Visa Application Centre (VFS Global)",
  address: "Park Road, Chak Shahzad, (Opposite CDA Park), Islamabad",
  phone: "0900 07860 (VFS Helpline)",
  email: "info.norwaypk@vfshelpline.com",
  note: "This is the official partner for submitting your application and biometrics."
};

// --- Norway-Specific FAQs ---
const faqs = [
  {
    q: "What is the processing time for a Norway visa?",
    a: "The processing time for a Norway visit visa from Pakistan is usually between 15 and 25 days after your application has been submitted at the VFS Global centre."
  },
  {
    q: "Can I apply for a Norway visa online?",
    a: "No, Pakistani citizens must apply for a Schengen sticker visa. This requires an online application *form* (on the UDI portal), followed by an *in-person* appointment at VFS Global. O.S. Travel & Tours manages this entire process for you."
  },
  {
    q: "Is a Police Clearance Certificate required for a Norway visa?",
    a: "Yes, your website lists a 'Police clearances' certificate as a required document for the Norway visa application. We will guide you on obtaining this."
  }
];

// --- Norway/Schengen-Specific Reviews ---
const reviews = [
  {
    name: "Ammar S.",
    quote: "O.S. Travel is the best for Schengen visas. They prepared my entire file for my Norway (Oslo) trip. I was so worried, but they handled everything. Got my visa!",
    rating: 5
  },
  {
    name: "Faiza K.",
    quote: "I highly recommend their file processing service for my Norway Fjord tour. They arranged my appointment and all my bookings. I just had to show up at VFS. Very professional.",
    rating: 5
  },
  {
    name: "The Ghauri Family",
    quote: "We used O.S. Travel for our family vacation to Norway. They processed all our applications. The file was perfect, and the visa was approved. Thank you!",
    rating: 5
  }
];
  ...
  return (
    ...
    >
      ...
      <motion.div variants={itemVariants} className="flex items-center gap-4 mb-8">
        <img
          src="https://flagcdn.com/w160/no.png" // Norway flag
          alt="Flag of Norway"
      ...
      >
        <h2 className="text-3xl font-bold text-gray-800 mb-6 text-center">
          Why Choose O.S. Travel for Your <span className="text-blue-600">Norway Visa</span>?
        </h2>
      ...
      <motion.div variants={itemVariants} className="text-center mt-10 text-sm text-gray-500">
        <p>Visa approval is at the sole discretion of the Royal Norwegian Embassy. O.S. Travel & Tours provides expert file preparation services.</p>
      </motion.div>
