...
// --- Page Data ---
// Data fetched directly from ostravels.com/schengen-visa-file-processing/poland-visa/
...
const processingService = {
  ...
  serviceIncludes: [
    ...
    "Application Form Filling (e-konsulat system)",
  ...
  documents: [
    ...
    "Pictures with White Background (3.5cm x 4.5cm)",
  ...
  note: "Embassy fee (90 EUR) and VFS Global fee are paid separately from our expert service charges. All fees are non-refundable."
};

const embassyInfo = {
  title: "Embassy of Poland, Islamabad",
  address: "Diplomatic Enclave II, Street 24, G-5/4, Islamabad, Pakistan",
  phone: "(+92-51) 260-04-80",
  email: "islamabad.amb.sekretariat@msz.gov.pl",
  note: "All visa applications are submitted through VFS Global, not the embassy directly."
};

const vfsInfo = {
  title: "Poland Visa Application Centre (VFS Global)",
  address: "Park Road, Chak Shahzad, (Opposite CDA Park), Islamabad",
  phone: "0900 07860 (VFS Helpline)",
  email: "info.polandpk@vfshelpline.com",
  note: "This is the official partner for submitting your application and biometrics."
};

// --- Poland-Specific FAQs ---
const faqs = [
  {
    q: "What is the processing time for a Poland visa?",
    a: "The standard processing time is 15 calendar days, but your site notes it can be extended up to 45 days. We recommend applying at least 6-8 weeks in advance."
  },
  {
    q: "Can I apply for a Poland visa online?",
    a: "No, Pakistani citizens must apply for a Schengen sticker visa. You must fill an online form via the 'e-konsulat' system, then attend an *in-person* appointment at VFS Global. O.S. Travel & Tours manages this entire process for you."
  },
  {
    q: "What is 'Schengen Visa File Processing'?",
    a: "It means O.S. Travel & Tours, as your consultant, handles the entire complex process. We fill the forms, book your flight/hotel reservations, arrange your travel insurance, and schedule your VFS appointment. You just provide your personal documents."
  }
];

// --- Poland/Schengen-Specific Reviews ---
const reviews = [
  {
    name: "Yusuf K.",
    quote: "O.S. Travel is the best for Schengen visas. They prepared my entire file for my Poland (Warsaw) trip. I was so worried, but they handled everything. Got my visa!",
    rating: 5
  },
  {
    name: "A. Khan",
    quote: "I highly recommend their file processing service for my Krakow trip. They arranged my appointment and all my bookings. I just had to show up at VFS. Very professional.",
    rating: 5
  },
  {
    name: "The Cheema Family",
    quote: "We used O.S. Travel for our family vacation to Poland. They processed all our applications. The file was perfect, and the visa was approved. Thank you!",
    rating: 5
  }
];
  ...
  return (
    ...
    >
      ...
      <motion.div variants={itemVariants} className="flex items-center gap-4 mb-8">
        <img
          src="https://flagcdn.com/w160/pl.png" // Poland flag
          alt="Flag of Poland"
      ...
      >
        <h2 className="text-3xl font-bold text-gray-800 mb-6 text-center">
          Why Choose O.S. Travel for Your <span className="text-blue-600">Poland Visa</span>?
        </h2>
        <p className="text-lg text-gray-600 text-center mb-8 max-w-3xl mx-auto">
          As the "best and top travel consultant" in Islamabad, we specialize in Schengen visas.
          <strong className="text-gray-800"> We deal in complete visa file processing and appointment scheduling</strong> to ensure your application is submitted correctly and efficiently.
        </p>
      ...
      <motion.div variants={itemVariants} className="text-center mt-10 text-sm text-gray-500">
        <p>Visa approval is at the sole discretion of the Embassy of Poland. O.S. Travel & Tours provides expert file preparation services.</p>
      </motion.div>
