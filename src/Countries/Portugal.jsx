...
// --- Page Data ---
// Data based on official VFS Global & Embassy sources for Portugal.
...
const processingService = {
 ...
 processingTime: "15 to 30 Working Days (After Appointment)",
  ...
  documents: [
    "Original Passport (valid 3+ months after stay) & all old passports",
    "Pictures with White Background (35mm x 45mm)",
    "Last 6-month Bank Statement & Maintenance Letter",
    "CNIC Photo Copy (front & back)",
    "Family Registration Certificate (FRC) (Attested by MOFA)",
    "Income Tax Returns & NTN (last 2 fiscal years)",
    "Employment Letter / Business Documents",
    "Invitation Letter (if visiting family/friends, attested in Portugal)"
  ],
  note: "Embassy fee (90 EUR) and VFS Global fee are paid separately from our expert service charges. Fees are non-refundable."
};

const embassyInfo = {
  title: "Embassy of Portugal, Islamabad",
  address: "House 2, Street 72, F-8/3, Islamabad, Pakistan",
  phone: "(051) 2262241",
  email: "sconsular.islamabad@mne.pt",
  note: "All visa applications are submitted through VFS Global, not the embassy directly."
};

const vfsInfo = {
  title: "Portugal Visa Application Centre (VFS Global)",
  address: "Park Road, Chak Shahzad, (Opposite CDA Park), Islamabad",
  phone: "0900 07860 (VFS Helpline)",
  email: "info.portugalpk@vfshelpline.com",
  note: "This is the official partner for submitting your application and biometrics."
};

// --- Portugal-Specific FAQs ---
const faqs = [
  {
    q: "Is Portugal a Schengen country?",
    a: "Yes, Portugal is a full member of the Schengen Area. A visa for Portugal is a Schengen visa, allowing you to travel to all 29 member countries."
  },
  {
    q: "Can I apply for a Portugal visa online?",
  ...
  {
    q: "What is the 'Termo de Responsabilidade'?",
    a: "This is the official Invitation Letter required if you are visiting family or friends. It must be signed by your host and certified by a public notary in Portugal. For tourism, we provide confirmed hotel bookings instead."
  }
];

// --- Portugal/Schengen-Specific Reviews ---
const reviews = [
  {
    name: "Usman A.",
    quote: "O.S. Travel is the best for Schengen visas. They prepared my entire file for my Portugal (Lisbon) trip. I was so worried, but they handled everything. Got my visa!",
    rating: 5
  },
  {
    name: "Maria B.",
    quote: "I highly recommend their file processing service for my trip to Algarve. They arranged my appointment and all my bookings. I just had to show up at VFS. Very professional.",
    rating: 5
  },
  {
    name: "The Shah Family",
    quote: "We used O.S. Travel for our family vacation to Portugal. They processed all our applications. The file was perfect, and the visa was approved. Thank you!",
    rating: 5
  }
];
  ...
  return (
    ...
    >
      ...
      <motion.div variants={itemVariants} className="flex items-center gap-4 mb-8">
        <img
          src="https://flagcdn.com/w160/pt.png" // Portugal flag
      ...
      >
        <h2 className="text-3xl font-bold text-gray-800 mb-6 text-center">
          Why Choose O.S. Travel for Your <span className="text-blue-600">Portugal Visa</span>?
        </h2>
      ...
      <motion.div variants={itemVariants} className="text-center mt-10 text-sm text-gray-500">
        <p>Visa approval is at the sole discretion of the Embassy of Portugal. O.S. Travel & Tours provides expert file preparation services.</p>
      </motion.div>
