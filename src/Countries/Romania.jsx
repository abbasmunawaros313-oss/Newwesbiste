...
// --- Page Data ---
// Data based on official Schengen/Romania requirements for Pakistan.
...
const processingService = {
  ...
  serviceIncludes: [
    ...
    "Application Form Filling (E-VIZA portal)",
...
const embassyInfo = {
  title: "Embassy of Romania, Islamabad",
  address: "House No. 7, Street 13, Sector F-7/2, Islamabad",
  phone: "+92 51 260 16 06",
  email: "islamabad@mae.ro",
  note: "All visa applications are submitted through VFS Global, not the embassy directly."
};

const vfsInfo = {
  title: "Romania Visa Application Centre (VFS Global)",
  address: "Park Road, Chak Shahzad, (Opposite CDA Park), Islamabad",
  phone: "0900 07860 (VFS Helpline)",
  email: "info.romaniapk@vfshelpline.com",
  note: "This is the official partner for submitting your application and biometrics."
};

// --- Romania-Specific FAQs ---
const faqs = [
  {
    q: "Is Romania part of the Schengen Area?",
    a: "Yes, as of March 31, 2024, Romania is a full member of the Schengen Area. A visa for Romania is a Schengen visa, which allows you to travel to all 29 member countries."
  },
  {
    q: "Can I apply for a Romania e-visa?",
    a: "No, Pakistani citizens must apply for a Schengen sticker visa. This requires an online application *form* (on the E-VIZA portal), followed by an *in-person* appointment at VFS Global. O.S. Travel & Tours manages this entire process for you."
  },
  {
    q: "How long does the Romania visa take?",
    a: "The standard processing time is 15 calendar days, but it can be extended up to 45 days. We recommend applying at least 6-8 weeks before your trip."
  }
];

// --- Romania/Schengen-Specific Reviews ---
const reviews = [
  {
    name: "Yaseen K.",
    quote: "O.S. Travel is the best for Schengen visas. They prepared my entire file for my Romania (Bucharest) trip. I was so worried, but they handled everything. Got my visa!",
    rating: 5
  },
  {
    name: "S. Aslam",
    quote: "I highly recommend their file processing service for my Transylvania tour. They arranged my appointment and all my bookings. I just had to show up at VFS. Very professional.",
    rating: 5
  },
  {
    name: "The Pervaiz Family",
    quote: "We used O.S. Travel for our family vacation to Romania. They processed all our applications. The file was perfect, and the visa was approved. Thank you!",
    rating: 5
  }
];
  ...
  return (
    ...
    >
      ...
      <motion.div variants={itemVariants} className="flex items-center gap-4 mb-8">
        <img
          src="https://flagcdn.com/w160/ro.png" // Romania flag
          alt="Flag of Romania"
      ...
      >
        <h2 className="text-3xl font-bold text-gray-800 mb-6 text-center">
          Why Choose O.S. Travel for Your <span className="text-blue-600">Romania Visa</span>?
        </h2>
        <p className="text-lg text-gray-600 text-center mb-8 max-w-3xl mx-auto">
          As the "best and top travel consultant" in Islamabad, we specialize in new Schengen countries like Romania.
      ...
      <motion.div variants={itemVariants} className="text-center mt-10 text-sm text-gray-500">
        <p>Visa approval is at the sole discretion of the Embassy of Romania. O.S. Travel & Tours provides expert file preparation services.</p>
      </motion.div>
