...
// --- Page Data ---
// Data based on official VFS/Embassy sources and YOUR provided fees.
...
const processingService = {
  ...
  documents: [
    ...
    "Last 6-month Bank Statement & Maintenance Letter (Certified)",
    "CNIC Photo Copy (front & back)",
    "Family Registration Certificate (FRC)",
    "Police Clearance Certificate (Mandatory for 18+)",
    "Yellow Fever Vaccination Certificate",
    "Employment Letter / Business Documents (NTN, etc.)"
  ],
  note: "Our expert service charge (PKR 50,000) is separate from the official Visa & VFS fees (PKR 3,300-5,300). All fees are non-refundable."
};

const highCommissionInfo = {
  title: "South African High Commission, Islamabad",
  address: "Street 48, Sector F-8/2, Islamabad, Pakistan",
  phone: "+92 (51) 226 2354",
  email: "islamabad.visa@dirco.gov.za",
  note: "All visa applications are submitted through VFS Global, not the embassy directly."
};

const vfsInfo = {
  title: "South Africa Visa Application Centre (VFS Global)",
  address: "Park Road, Chak Shahzad, (Opposite CDA Park), Islamabad",
  phone: "0900 07860 (VFS Helpline)",
  email: "info.sapksa@vfshelpline.com",
...
const faqs = [
  {
    q: "Can I apply for a South Africa e-visa?",
    a: "No, Pakistani citizens are currently not eligible for the South African e-visa system. You must apply for a traditional sticker visa by submitting your file in person at a VFS Global centre. We handle this entire file preparation and appointment process."
  },
  {
    q: "What is the total fee for the South Africa visa?",
    a: "The cost is in three parts: 1) The official visa fee which varies from PKR 3,300 to 5,300. 2) The VFS Global service fee. 3) Our expert file processing & appointment scheduling service charge of PKR 50,000."
  },
  {
    q: "Is the Police Clearance Certificate mandatory?",
    a: "Yes, for all applicants aged 18 years and older, a Police Clearance Certificate is a mandatory document for the visa application."
  }
];

// --- South Africa-Specific Reviews ---
const reviews = [
  {
    name: "Hassan A.",
    quote: "O.S. Travel is the best for South Africa! They prepared my entire file for my Cape Town trip. I was so worried about the police certificate, but they guided me perfectly.",
    rating: 5
  },
  {
    name: "Sobia M.",
    quote: "I highly recommend their file processing service for my Safari trip. They arranged my appointment and all my bookings. I just had to show up at VFS. Very professional.",
    rating: 5
  },
  {
    name: "The Jafri Family",
    quote: "We used O.S. Travel for our family vacation to South Africa. They processed all our applications. The file was perfect, and the visa was approved. Thank you!",
    rating: 5
  }
];
  ...
  return (
    ...
    >
      ...
      <motion.div variants={itemVariants} className="flex items-center gap-4 mb-8">
        <img
          src="https://flagcdn.com/w160/za.png" // South Africa flag
      ...
      >
        <h2 className="text-3xl font-bold text-gray-800 mb-6 text-center">
          Why Choose O.S. Travel for Your <span className="text-blue-600">South Africa Visa</span>?
        </h2>
        <p className="text-lg text-gray-600 text-center mb-8 max-w-3xl mx-auto">
          The South Africa visa is a detailed, in-person application. As expert visa consultants in Islamabad,
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <ServiceCard
            ...
            desc="We handle the BI-84 form and ensure all documents, like the Police Certificate, are correct."
          />
          <ServiceCard
          ...
          />
          <ServiceCard
            icon={<FaPaw className="text-yellow-500" />}
            title="Safari Packages"
            desc="We can plan your entire trip, including hotels, flights, and safari bookings."
          />
        </div>
      </motion.div>
      ...
      <motion.div variants={itemVariants} className="text-center mt-10 text-sm text-gray-500">
        <p>Visa approval is at the sole discretion of the South African High Commission. O.S. Travel & Tours provides expert file preparation services.</p>
      </motion.div>
  ...
  return (
    <div className={`bg-white rounded-lg shadow-xl overflow-hidden border-t-8 border-blue-600`}>
      <div className="p-6 md:p-8">
        ...
        {/* Details Grid - UPDATED with your fees */}
        <div className="grid grid-cols-2 md:grid-cols-3 gap-y-6 gap-x-4 mb-6 pt-4 border-t border-gray-100">
          ...
          <DetailItem icon={<FaPassport className="text-gray-600" />} label="VFS & Govt. Fees" value={visa.visaFee} />
