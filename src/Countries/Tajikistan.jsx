...
const eVisa = {
  ...
  documents: [
    ...
    "Id Card Scan Copy",
    "1 White Background Picture"
  ],
  note: "O.S. Travel & Tours can help you process the online E-Visa, which is faster and more convenient.",
  isSticker: false
};
...
const embassyInfo = {
  title: "Tajikistan Embassy/Consulate In Islamabad",
  address: "House# 295, Street# 35, F 11/3, Islamabad 44000, Pakistan",
  phone: "(0092) 051-2293462",
  fax: "(0092) 051-2299710",
  email: "tajemb_islamabad@inbox.ru, info@tajikembassy.pk"
};

// --- Tajikistan-Specific FAQs ---
const faqs = [
  {
    q: "What is the difference between the E-Visa and the Sticker Visa?",
    a: "The E-Visa is an online process that only requires scanned documents (passport, ID, photo). The Sticker Visa is a traditional process that requires your original passport, bank statements, an invitation letter, and other documents to be submitted to the consulate."
  },
  {
    q: "Do I need an Invitation Letter for the E-Visa?",
    a: "No, based on the documents list from O.S. Travel & Tours, the E-Visa does not require an Invitation Letter, making it a much simpler option for tourists."
  },
  {
    q: "Is the E-Visa processing time faster?",
    a: "While both are listed with a 7-10 working day processing time, the E-Visa process is generally more convenient as it avoids the courier and submission time of original documents to the embassy."
  }
];

// --- Tajikistan-Specific Reviews ---
const reviews = [
  {
    name: "Kamal S.",
    quote: "I was planning a trip to Central Asia and O.S. Travel handled my Tajikistan e-visa. It was incredibly simple. I just emailed my documents. Got the visa in about a week.",
    rating: 5
  },
  {
    name: "Alia R.",
    quote: "Used O.S. Travel for my sticker visa as I needed it for business. They were very clear about the invitation letter requirement and helped me get all my documents in order. Great service.",
    rating: 5
  },
  {
    name: "Dushanbe Traders",
    quote: "Very professional service for the Tajikistan visa. Fast, reliable, and they know the process well. Recommended for any travel to Tajikistan.",
    rating: 5
  }
];
  ...
  return (
    ...
    >
      ...
      <motion.div variants={itemVariants} className="flex items-center gap-4 mb-8">
        <img
          src="https://flagcdn.com/w160/tj.png" // Tajikistan flag
      ...
      >
        ...
        <ul className="space-y-4 text-gray-700 text-lg">
          ...
          <li className="flex items-start gap-4">
            ...
            <span><strong>Email:</strong> <a href={`mailto:${embassyInfo.email.split(',')[0]}`} className="text-blue-600 hover:underline">{embassyInfo.email}</a></span>
          </li>
        </ul>
      </motion.div>
      ...
      >
        ...
        <p className="text-lg text-gray-600 text-center mb-8 max-w-3xl mx-auto">
          The Tajikistan visa application can be "complex and confusing."
          <strong className="text-gray-800"> We deal in a wide range of services</strong> to make the process easier and stress-free for you.
        </p>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <ServiceCard
            icon={<FaLaptopCode className="text-blue-500" />}
            title="E-Visa Processing"
            desc="We handle the complex online e-visa application on your behalf for a smooth process."
          />
          <ServiceCard
            icon={<FaPassport className="text-purple-500" />}
            title="Sticker Visa Assistance"
            desc="We assist in preparing all documents for the embassy, including the Invitation Letter."
          />
          <ServiceCard
            icon={<FaPlane className="text-green-500" />}
            title="Air Ticketing"
            desc="Get the best fares on Somon Air and other carriers to Dushanbe (DYU)."
          />
          <ServiceCard
            icon={<FaHotel className="text-yellow-500" />}
            title="Hotel Bookings"
            desc="We arrange confirmed hotel bookings which are a mandatory part of the visa application."
          />
        </div>
      </motion.div>
