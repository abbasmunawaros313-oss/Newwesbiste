...
import {
  ...
  FaPoundSign // Icon for Pound
} from 'react-icons/fa';

// --- Page Data ---
// Data fetched directly from ostravels.com/schengen-visa-file-processing/united-kingdom-uk-visa/
...
const processingService = {
  ...
  documents: [
    ...
    "Pictures with White Background (45mm x 35mm)",
  ...
  note: "Govt. visa fee (£127) and VFS Global fee are paid separately from our expert service charges. All fees are non-refundable."
};
...
const highCommissionInfo = {
  ...
  email: "N/A (Contact via web form)",
  note: "All visa applications are submitted through VFS Global, not the High Commission directly."
};

const vfsInfo = {
  title: "UK Visa Application Centre (VFS Global)",
...
const faqs = [
  {
    q: "Is the UK part of the Schengen Area?",
    a: "No. The UK is not a member of the Schengen Area. A Schengen visa is not valid for travel to the UK, and a UK visa is not valid for travel to Schengen countries. You must apply for them separately."
  },
  {
    q: "Can I apply for a UK visa online?",
    a: "You must fill the application form online, but you cannot get an e-visa. You must attend an *in-person* appointment at VFS Global to submit your documents and provide biometrics. O.S. Travel & Tours manages this entire process for you."
  },
  {
    q: "What is the 'File Processing' service?",
    a: "The UK application is very detailed. Our service means we handle the complex online form, help you gather and arrange all required documents, book your VFS appointment, and provide confirmed flight/hotel bookings to build a strong, successful application file."
  },
  {
    q: "How much bank balance is required for a UK visa?",
    a: "It is crucial to show sufficient funds. We recommend a consistent bank statement with a strong closing balance, ideally over PKR 1,500,000 to 2,000,000, along with proof of a steady income."
  }
];
...
const reviews = [
  {
    name: "Tariq A.",
    quote: "O.S. Travel is the best for UK visas. They prepared my file for my London trip, and it was perfect. The application is very long, but they handled everything. Got my visa!",
    rating: 5
  },
  {
    name: "Sobia M.",
    quote: "I highly recommend their UK file processing service. They arranged my appointment and all my bookings. I just had to show up at VFS. Very professional.",
    rating: 5
  },
  {
    name: "The Cheema Family",
    quote: "We used O.S. Travel for our family visitor visa to Manchester. They processed all our applications together. The file was perfect, and the visa was approved. Thank you!",
    rating: 5
  }
];
  ...
  return (
    ...
    >
      ...
      <motion.div variants={itemVariants} className="flex items-center gap-4 mb-8">
        <img
          src="https://flagcdn.com/w160/gb.png" // UK flag
          alt="Flag of UK"
      ...
      >
        <h2 className="text-3xl font-bold text-gray-800 mb-6 text-center">
          Why Choose O.S. Travel for Your <span className="text-blue-600">UK Visa</span>?
        </h2>
        <p className="text-lg text-gray-600 text-center mb-8 max-w-3xl mx-auto">
          The UK visa application is "a difficult task" and can be "confusing." As the "top travel agents in Pakistan specializing in UK visa applications,"
          <strong className="text-gray-800"> we deal in complete visa file processing and appointment scheduling</strong> to ensure a high success rate.
        </p>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <ServiceCard
            icon={<FaFileSignature className="text-blue-500" />}
            title="UK File Processing"
            desc="Expert preparation of your online application and all complex supporting documents."
          />
          <ServiceCard
          ...
          <ServiceCard
            ...
            desc="We issue a comprehensive travel insurance policy suitable for your UK visit."
          />
        </div>
      </motion.div>
      ...
      <motion.div variants={itemVariants} className="text-center mt-10 text-sm text-gray-500">
        <p>Visa approval is at the sole discretion of the UK Home Office. O.S. Travel & Tours provides expert file preparation services.</p>
      </motion.div>
    ...
    <div className={`bg-white rounded-lg shadow-xl overflow-hidden border-t-8 border-blue-600`}>
      <div className="p-6 md:p-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-y-6 gap-x-4 mb-6 pt-4 border-t border-gray-100">
          <DetailItem icon={<FaPoundSign className="text-green-600" />} label="Govt. Visa Fee" value={visa.totalFee} />
...
const EmbassyCard = ({ info }) => (
  <div className="bg-white p-6 md:p-8 rounded-lg shadow-lg flex flex-col">
    <h2 className="text-2xl font-bold text-gray-800 mb-5 flex items-center gap-3">
      <FaBuilding className={info.title.includes("Embassy") || info.title.includes("High Commission") ? "text-red-700" : "text-blue-700"} />
      {info.title}
    </h2>
