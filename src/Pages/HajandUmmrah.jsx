        ...
        >
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              We offer a variety of Umrah packages from Pakistan, designed to fit your budget and comfort. 
              All packages include visa, flights, hotels, and transport.
            </p>
          </div>
          <motion.div
...
const PackageCard = ({ pkg }) => (
  <motion.div
    variants={gridItemVariant}
    className={`bg-white rounded-lg shadow-xl flex flex-col border-t-8 ${
      pkg.isRecommended ? "border-blue-500" : "border-gray-300"
    }`}
  >
    <div className="p-6">
      {pkg.isRecommended && (
        <span className="inline-block bg-blue-500 text-white text-xs font-bold px-3 py-1 rounded-full mb-3 uppercase">
          Recommended
        </span>
      )}
      <h3 className="text-2xl font-extrabold text-gray-900 mb-2">{pkg.title}</h3>
      <p className="text-lg font-semibold text-blue-600 mb-4">{pkg.duration}</p>
      <p className="text-sm text-gray-600 mb-4">
        <span className="font-bold">Hotels:</span> {pkg.hotels}
      </p>
    </div>
