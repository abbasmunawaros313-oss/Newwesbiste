...
export default function InsuranceForm() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex items-start justify-center py-6 px-4 sm:px-6 lg:px-8">
...
const DateSelector = ({ value, onChange, error, range = 'past' }) => {
    ...
    const selectClass = `block w-full py-3 px-2 border rounded-lg bg-slate-50 focus:bg-white focus:outline-none focus:ring-2 transition duration-150 text-sm ${
