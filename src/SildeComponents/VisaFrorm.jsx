...
function VisaForm() {
  ...
  return (
    <div className="mt-5 max-w-xl mx-auto p-4 sm:p-6 bg-white rounded-xl shadow-lg">
      ...
      {/* 2. Form Grid (Reduced to two columns/fields) */}
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              value="Pakistan"
              readOnly
              className="w-full h-14 pl-12 pr-4 py-3 border border-gray-300 bg-gray-100 rounded-lg focus:outline-none cursor-not-allowed font-semibold text-gray-600"
            />
      ...
      <div className="mt-8">
        ...
        <button 
          ...
          className="w-full bg-blue-500 hover:bg-blue-600 text-white font-bold text-lg rounded-lg px-16 py-3 transition-colors"
        >
